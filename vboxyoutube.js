$(".link-lightbox").on("click", function() {
    ...
    var b = '<iframe src="" width="640" height="480" id="video-embed" style="border:0;"></iframe>',
        ...
        g = '<div id="window">',
        h = '<div id="ref"><a href="//wiisam21.blogspot.com/2018/03/jquery-on-click-pop-up-light-box-video.html" rel="nofollow" target="_blank">مطورة من طرف : wesam developer</a>',
        i = "</div></div></div></div>";
